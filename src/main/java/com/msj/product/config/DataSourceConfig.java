package com.msj.product.config;
...
@Configuration
@MapperScan(basePackages = "com.msj.product.mapper", sqlSessionFactoryRef = "sqlSessionFactory", sqlSessionTemplateRef = "sqlSessionTemplate")
